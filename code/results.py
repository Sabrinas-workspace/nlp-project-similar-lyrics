...
for child in root:
    ...
    more_similar_songs_nouns = songtext_topics.more_similar_songs(child, root)
    less_similar_songs_nouns = songtext_topics.less_similar_songs(child, root)
    similar_songs_adj = songtext_adjectives.find_similar_songs(child, root)
    similar_song_sentiment = songtext_sentiment.similar_sentiment(child, root)
